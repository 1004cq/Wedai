export default {
  ...
  'betterAuth.authMethod.email': 'Email',
  'betterAuth.authMethod.phone': 'Phone',
  'betterAuth.phone.sendOtp': 'Send verification code',
  'betterAuth.phone.verifySubmit': 'Verify and continue',
  'betterAuth.phone.phonePlaceholder': 'Mobile number',
  'betterAuth.phone.otpPlaceholder': '6-digit code',
  'betterAuth.phone.otpSentTo': 'Code sent to +86 {{phone}}',
  'betterAuth.phone.resend': 'Resend code',
  'betterAuth.phone.resendCountdown': 'Resend in {{seconds}}s',
  'betterAuth.phone.changePhone': 'Change number',
  'betterAuth.phone.otpResent': 'Verification code resent',
  'betterAuth.phone.errors.phoneRequired': 'Please enter your mobile number',
  'betterAuth.phone.errors.invalidPhone': 'Please enter a valid mainland China mobile number',
  'betterAuth.phone.errors.otpRequired': 'Please enter the verification code',
  'betterAuth.phone.errors.otpLength': 'Verification code must be 6 digits',
  'betterAuth.phone.errors.sendFailed': 'Failed to send verification code. Please try again',
  'betterAuth.phone.errors.verifyFailed': 'Verification failed. Please try again',
  'betterAuth.phone.errors.invalidOtp': 'Incorrect verification code',
  'betterAuth.phone.errors.otpExpired': 'Verification code expired. Please request a new one',
  'betterAuth.phone.errors.tooManyAttempts':
    'Too many incorrect attempts. Please request a new code',
  'betterAuth.phone.errors.rateLimited': 'Too many requests. Please wait before trying again',
