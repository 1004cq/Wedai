export default {
  ...
  'heteroImport.badge.linked': 'From Wedai',
  'heteroImport.badge.linkedTip':
    'This session was started from Wedai and already lives in your topic list',
  ...
  'heteroImport.error.desc':
    'Could not read the local sessions. Check that Wedai can access your transcripts, then retry.',
