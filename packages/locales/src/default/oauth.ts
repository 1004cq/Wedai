export default {
  ...
  'consent.scope.openid': 'Authenticate using your Wedai account',
  ...
  'consent.thirdParty.notice':
    'This application is created by a third-party developer and is not operated by Wedai. Once authorized, it can act on your behalf and use your account quota.',
